...
if (existsSync(unpacked)) {
  ...
  try {
    ...
    assert.match(packagedGemini, /Browser\.setWindowBounds/, "packaged Gemini automation should maximize the actual Chrome window");
    ...
    assert.match(packagedFlowAutomation, /Browser\.setWindowBounds/, "packaged Flow automation should maximize the actual Chrome window");
